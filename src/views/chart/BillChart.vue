<template>
  <div class="bill-chart">
    <h1 class="animate-pulse">📊 Thống kê Hóa đơn</h1>
    <p class="subtitle">Thống kê tỷ lệ các loại mục trong hóa đơn (Sản phẩm, Dịch vụ, Thú cưng)</p>
...
const chartData = [
  ['Category', 'Value'],
  ['Sản phẩm', dataRes.total_product],
  ['Thú cưng', dataRes.total_pet],
  ['Dịch vụ', dataRes.total_service],
]
const data = window.google.visualization.arrayToDataTable(chartData)
const options = {
  title: 'Tỷ lệ các mục trong Hóa đơn',
  is3D: true,
