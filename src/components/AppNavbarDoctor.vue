  ...
  <nav v-if="isDoctor">
    <div class="logo-section">
      ...
      <span class="brand-name">
        <router-link to="/doctor">Trang Hmm Doctor</router-link>
      </span>
    </div>
    ...
    <ul :class="{ active: isMenuOpen }">
      <li><router-link :to="`/doctor/${doctorId}`"><span>🏠</span> Trang chủ</router-link></li>
      <li><router-link to="/doctorbill"><span>🧾</span> Hóa đơn</router-link></li>
      <li><router-link :to="`/doctorbooking/${doctorId}`"><span>🩺</span> Đặt lịch khám</router-link></li>
      <li><router-link to="/doctorwork"><span>💼</span> Công việc</router-link></li>
      <li v-if="isLoggedIn">
